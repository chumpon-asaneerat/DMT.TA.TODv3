...
{
    /// <summary>
    /// Interaction logic for ReturnCouponPage2.xaml
    /// </summary>
    public partial class ReturnCouponPage2 : UserControl
    {
        #region Constructor
        ...
        private void ReturnCoupon()
        {
            ...
            var win = TAApp.Windows.CollectorCouponReturn2;
            win.Setup(manager);
            win.ShowDialog();
            Reset();
            RefreshCoupons();
