...
namespace DMT.TOD.Pages.Reports
{
    ...
    public partial class EmpytRevenueSlipPage : UserControl
    {
        ...
        {
            get { return "revenue.form." + DateTime.Now.ToThaiDateTimeString("ddMMyyyyHHmmssfff"); }
        }
        ...
        private RdlcReportModel GetReportModel()
        {
            ...
            inst.Definition.EmbededReportName = "DMT.TOD.Reports.RevenueSlipNull2.rdlc";
            ...
            items.Add(new RevenueEntry()); // Add new because is blank.
