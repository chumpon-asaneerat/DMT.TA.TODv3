...
namespace DMT.Models
{
    ...
    public class Shift : NTable<Shift>
    {
        ...
        /// <param name="db">The database connection.</param>
        /// <returns>Returns List of Shift.</returns>
        public static NDbResult<List<Shift>> GetShiftAll(SQLiteConnection db)
        {
            var result = new NDbResult<List<Shift>>();
            if (null == db)
            {
        ...
        /// </summary>
        /// <returns>Returns List of Shift.</returns>
        public static NDbResult<List<Shift>> GetShiftAll()
        {
            lock (sync)
            {
                SQLiteConnection db = Default;
                return GetShiftAll(db);
            }
        }
