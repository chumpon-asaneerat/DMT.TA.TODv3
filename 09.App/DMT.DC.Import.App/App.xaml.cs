        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            EnvironmentOptions option = new EnvironmentOptions()
            {
                ...
                AppInfo = new NAppInformation()
                {
                    ...
                    CompanyName = "DMT",
                    /*  This property is required */
                    ProductName = AppConsts.Application.DCImporter.ApplicationName,
                    /* For Application Version */
                    Version = AppConsts.Application.DCImporter.Version,
                    Minor = AppConsts.Application.DCImporter.Minor,
                    Build = AppConsts.Application.DCImporter.Build,
                    LastUpdate = AppConsts.Application.DCImporter.LastUpdate
                },
                /* Setup Storage */
